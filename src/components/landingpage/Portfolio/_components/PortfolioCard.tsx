...
export const PortfolioCard = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <div
        className={`group relative overflow-hidden rounded-2xl bg-[hsl(var(--glass-bg))] backdrop-blur-glass border border-[hsl(var(--glass-border))] hover:border-primary transition-all duration-500 hover:shadow-glow ${sizeClasses[size]} animate-scale-in`}
      >
